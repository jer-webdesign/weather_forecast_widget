...
Background Images: Add the required background images to the images/ folder:

blue-sky.jpg (for light mode)
stars-constellation-universe-twin.jpg (for dark mode)


Open in Browser: Launch index.html in a modern web browser
No Server Required: The widget runs entirely in the browser
